...
import { Brain, Globe, Leaf, Lightbulb, Rocket } from 'lucide-react';
...
const InnovationPage = () => {
  ...
  const subsidiaries = [
    {
      ...
      innovation: "AI-powered digital platforms and automation solutions.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      logo: athimartLogo,
      name: "Athimart",
      innovation: "Smart e-commerce with personalized shopping experiences.",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      logo: fixthanLogo,
      name: "Fixthan",
      innovation: "AI-powered home service booking and technician dispatch.",
      gradient: "from-orange-500 to-red-500"
    },
    {
      logo: agrozinLogo,
      name: "Agrozin",
      innovation: "Precision agriculture using IoT sensors and analytics.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      logo: agroherdsLogo,
      name: "Agroherds",
      innovation: "AI-driven livestock monitoring and health analytics.",
      gradient: "from-lime-500 to-green-500"
    },
    {
      logo: tidroxLogo,
      name: "Tidrox",
      innovation: "Sustainable seafood tracking and traceability.",
      gradient: "from-blue-600 to-teal-500"
    },
    {
      logo: eatzweeLogo,
      name: "Eatzwee",
      innovation: "Smart kitchen automation and menu optimization.",
      gradient: "from-orange-500 to-red-500"
    },
    {
      logo: pistanoLogo,
      name: "Pistano",
      innovation: "Connected vehicle technology and diagnostics.",
      gradient: "from-gray-600 to-gray-800"
    },
    {
      logo: shipzemLogo,
      name: "Shipzem",
      innovation: "Smart logistics with AI route optimization.",
      gradient: "from-indigo-500 to-blue-600"
    },
    {
      logo: neonzerLogo,
      name: "Neonzer",
      innovation: "Renewable energy and smart grid technology.",
      gradient: "from-yellow-500 to-orange-500"
    },
    {
      logo: genexzaLogo,
      name: "Genexza",
      innovation: "AI-powered public transit and urban mobility.",
      gradient: "from-sky-500 to-blue-500"
    },
    {
      logo: tripzemLogo,
      name: "Tripzem",
      innovation: "AI-powered travel planning and booking.",
      gradient: "from-sky-500 to-blue-500"
    },
    {
      logo: finexzaLogo,
      name: "Finexza",
      innovation: "Fintech solutions and investment analysis.",
  ...
  const achievements = [
    { number: "13", label: "Innovative Subsidiaries" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-white">
              Innovation at MBR Group
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Pioneering the future with technology and sustainable solutions
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible.core ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Our Innovation <span className="text-[#2d4c7b]">Pillars</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Core technologies driving innovation across all our subsidiaries
            </p>
          </div>
              ...
              return (
                <div
                  ...
                  className={`group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 ${
                    isVisible.core ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                  }`}
      ...
      <section id="subsidiaries" ref={(el) => (sectionsRef.current.subsidiaries = el)} className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible.subsidiaries ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Innovation Across <span className="text-[#2d4c7b]">All Businesses</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Each subsidiary leverages cutting-edge technology to revolutionize their industry
            </p>
          </div>
            ...
            {subsidiaries.map((company, index) => (
              <div
                ...
                className={`group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 overflow-hidden ${
                  isVisible.subsidiaries ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
                style={{ transitionDelay: `${index * 80}ms` }}
              >
                {/* Gradient Background Blob */}
                <div
                  className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${company.gradient} opacity-10 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-700`}
                ></div>

                {/* Logo Container */}
                <div className="relative z-10 mb-4">
                  <div className="w-14 h-14 rounded-xl overflow-hidden bg-white p-1 shadow-sm ring-2 ring-white/50 group-hover:ring-white/80 transition-all duration-300">
                    <Image
                      src={company.logo}
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 group-hover:bg-white/20 transition-all duration-300 border border-white/20">
                  <p className="text-5xl font-bold mb-2 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
                    {achievement.number}
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center max-w-4xl mx-auto transition-all duration-1000 ${isVisible.vision ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our Innovation <span className="text-[#2d4c7b]">Vision</span>
            </h2>
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              Creating intelligent, sustainable solutions that transform businesses and improve lives globally through innovation that makes a difference.
            </p>
            <button className="px-8 py-4 bg-gradient-to-r from-[#2d4c7b] to-[#1a2940] text-white rounded-xl font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105">
